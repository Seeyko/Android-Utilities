package com.tomandrieu.utilities.segmentedbutton;
...
import com.tomandrieu.utilities.drawables.DrawableHotspotTouch;
import com.tomandrieu.utilities.drawables.RippleDrawable;
...
public class SegmentedButton extends View {
    ...
    public void setSelectedBackgroundDrawable(int selectedButtonRadius) {
        this.selectedButtonRadius = selectedButtonRadius;
    }
    ...
    void setupBackgroundClipPath() {
        ...
        if (backgroundClipPath != null && VERSION.SDK_INT < VERSION_CODES.JELLY_BEAN_MR2)
    ...
    public void setRipple(@ColorInt int color) {
        ...
        if (VERSION.SDK_INT >= VERSION_CODES.LOLLIPOP) {
            ...
            rippleDrawable = new RippleDrawable(ColorStateList.valueOf(rippleColor), null,
                    null);
            // setCallback on Drawable allows animations to be scheduled and the drawable to invalidate the view on
            // animation
